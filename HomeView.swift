...
struct BackgroundGradientViewHome: View {
    var body: some View {
        LinearGradient(
            colors: [
                Color(hex: "#73D1F0").opacity(0.7),
...
//                            .padding(.horizontal)
                        ...
                        HomeCard(
                            ...
                            description: "0/100 signs completed",
                            gradient: [Color.blue, Color.blue.opacity(0.7)]
                        ) {
                            CircularProgressView(progress: 10 / 100)
...
struct AnimatedGradientViewLearn: View {
